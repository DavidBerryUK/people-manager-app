...
describe('Create Colour From Hsl', () => {


    test('Create Black', () => {
        const colour = ColourModel.hsl(0, 0, 0);
    ...
    test('Create White', () => {
        const colour = ColourModel.hsl(0, 1, 1);
    ...
    test('Create Red', () => {
        const colour = ColourModel.hsl(0, 1, 0.5);
        expect(colour.red).toBe(255);
        expect(colour.green).toBe(0);
        expect(colour.blue).toBe(0);
    ...
    test('Create Green', () => {
        const colour = ColourModel.hsl(120, 1, 0.5);
        expect(colour.red).toBe(0);
        expect(colour.green).toBe(255);
        expect(colour.blue).toBe(0);
    ...
    test('Create Blue', () => {
        const colour = ColourModel.hsl(240, 1, 0.5);
        expect(colour.red).toBe(0);
        expect(colour.green).toBe(0);
        expect(colour.blue).toBe(255);
    ...
    test('Create Yellow', () => {
        const colour = ColourModel.hsl(60, 1, 0.5);
        expect(colour.red).toBe(255);
        expect(colour.green).toBe(255);
        expect(colour.blue).toBe(0);
    ...
    test('Create Purple', () => {
        const colour = ColourModel.hsl(300, 1, 0.5);
        expect(colour.red).toBe(255);
        expect(colour.green).toBe(0);
        expect(colour.blue).toBe(255);
    ...
    test('Create Cyan', () => {
        const colour = ColourModel.hsl(180, 1, 0.5);
        expect(colour.red).toBe(0);
        expect(colour.green).toBe(255);
        expect(colour.blue).toBe(255);
